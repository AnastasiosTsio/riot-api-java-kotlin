...
public class LeagueEntryResponse private constructor(
    ...
    @JvmField public val ratedTier: String?,
    @JvmField public val ratedRating: Int?,
...
public class TopRatedLadderEntryResponse private constructor(
    @JvmField public val summonerId: String,
    @JvmField public val ratedTier: String,
    @JvmField public val ratedRating: Int,
    @JvmField public val wins: Int,
    @JvmField public val previousUpdateLadderPosition: Int,
){
    internal companion object {
        fun fromDto(dto: TopRatedLadderEntryDto): TopRatedLadderEntryResponse {
            return TopRatedLadderEntryResponse(
                summonerId = dto.summonerId,
                ratedTier = dto.ratedTier,
                ratedRating = dto.ratedRating,
                wins = dto.wins,
                previousUpdateLadderPosition = dto.previousUpdateLadderPosition,
            )
        }
    }
}
